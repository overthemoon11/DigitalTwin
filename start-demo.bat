...
start "HVAC Digital Twin - Backend" cmd /k "title HVAC Digital Twin - Backend && cd /d "%ROOT_DIR%backend" && echo. && echo Starting backend on http://localhost:3005... && echo. && npm start"
...
start "HVAC Digital Twin - Frontend" cmd /k "title HVAC Digital Twin - Frontend && cd /d "%ROOT_DIR%frontend" && echo. && echo Starting frontend on http://localhost:3004... && echo. && npm run dev"
