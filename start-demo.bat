...
start "HVAC Digital Twin - Backend" cmd /k "title HVAC Digital Twin - Backend && cd /d "%ROOT_DIR%backend" && echo. && echo Starting backend on http://localhost:3007... && echo. && npm start"
...
start "HVAC Digital Twin - Frontend" cmd /k "title HVAC Digital Twin - Frontend && cd /d "%ROOT_DIR%frontend" && echo. && echo Starting frontend on http://localhost:3006... && echo. && npm run dev"
...
echo   WebSocket:    ws://localhost:3007/ws
echo.
