...
// Requires both the backend (port 3007) and frontend (port 3006) to be running.
...
takeScreenshots().catch((err) => {
  ...
  console.error('Ensure both backend (port 3007) and frontend (port 3006) are running.');
  process.exit(1);
});
