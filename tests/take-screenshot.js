...
// Requires both the backend (port 3005) and frontend (port 3004) to be running.
...
takeScreenshots().catch((err) => {
  ...
  console.error('Ensure both backend (port 3005) and frontend (port 3004) are running.');
  process.exit(1);
});
